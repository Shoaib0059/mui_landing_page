...
const HeroPage = ({ show , color }) => {
    ...
    return (
        <Box sx={{ width:'100%',display:"flex",justifyContent:"center", backgroundColor: "#F8F3EC",}} className={Heropage_content} >
            <Box className={details_box} >
                <Box className={detail_right_box}>
                    <Box className={Hero_text}>
                        ...
                        <p className={para}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor. </p>
                    </Box>
                    <Box className={box_Details}>
                        <Box>
                            <Button sx={{ backgroundColor: "#F6D88C", padding: "10px", borderRadius: "10px", color: "#181817" }}>GET STARTED</Button>
                        </Box>
                ...
                <Box className={image_container}>
                    <Box ><img src="./Image/Rectangle 581.png" className={img}/></Box>
                    <Box ><img src="./Image/Rectangle 583.png" className={img}/></Box>
                </Box>
            </Box>
        </Box>
    );
